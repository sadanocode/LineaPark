...
#   Старгейт бридж
net_bridge = ['Arbitrum', 'Optimism']  # Сети, в которые будем бриджить (Arbitrum, Optimism)
...
USDC_volume = [10, 50]  # Количество USDC, на которое мы свапаем эфир за первый шаг
...
wstETH_volume = [15, 30]  # Стоимость эфира $, которое свапаем на wstETH за первый шаг
