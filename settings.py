...
usdc_limits = [0.1, 1]  # Количество USDC, которое свапаем на TROB, если USDC уже было на балансе
...
usdc_volume = [0.1, 1]  # Количество USDC на которое будем свапать эфир для дальнейших операций
